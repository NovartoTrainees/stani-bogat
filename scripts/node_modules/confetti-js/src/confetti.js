export function ConfettiGenerator(params) {
  ...
  var appstate = {
    ...
    max: 200, // Max itens to render
    size: 1, // prop size
    animate: true, // Should animate?
    respawn: true, // Should confettis be respawned when getting out of screen?
    props: ['circle', 'square', 'line'], // Types of confetti
    colors: [[255, 0, 0], [0, 0, 255], [0, 255, 0], [255, 248, 0]], // Colors to render confetti
    clock: 30, // Speed of confetti fall
